...
export default function Login(){
  ...
  <form className="form" action="" onSubmit={(event) => handleSubmit(event)}>   
    ...
    <br />
    <span>
            Don't have an account ? <Link to="/register" className="Link">Create new (OR) </Link>
            <button className="btn-1 btn-secondary" onClick={(e) =>testCredentials()}>Test Credentials</button>
    </span>
  </form>
</div>
      </FormContainer>
